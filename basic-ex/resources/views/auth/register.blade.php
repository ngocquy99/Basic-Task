...
<form method="post" action="{{ route('register.perform') }}">
    ...
    <img class="mb-4" src="assets/Bootstrap_logo.svg.png" alt="" width="65" height="50">
    ...
    <div class="container form-group form-floating mb-3 col-md-4 col-md-offset-5 align-center">
        <select class="form-control form-select " aria-label="Default select example" name="gender" placeholder="Gender" required="required">
