...
<h1> Update By User {{$info->username}}'s ID : {{$info->id}} </h1>
    <form method="post" action="{{ route('update.preform') }}">
        ...
        <input type="hidden" class="form-control" name="id" value="{{$info->id }}" placeholder="ID" required="required" autofocus>

        <h2 class="h3 mb-3 fw-normal">Update</h2>

        <div class="form-group form-floating mb-3">
            <input type="email" class="form-control" name="email" value="{{ $info->email  }}" placeholder="name@example.com" required="required" autofocus>
